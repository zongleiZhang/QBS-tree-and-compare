...
public class ClassMct {
    ...
    /*
    成都基准点
    static public double __B0 = 0.534943415736262; //标准纬度,弧度
    static public double __L0 = 1.8158405537749007; //原点经度,弧度
    */

    static public double __B0 = 0.5235987755982988; //标准纬度,弧度
    static public double __L0 = 1.8325957145940461; //原点经度,弧度
