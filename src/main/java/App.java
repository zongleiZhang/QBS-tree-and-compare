        ...
        public void run(){
            try {
                ...
                while (true) {
                    if (count <= tree_size) {
                        ...
                        if (segmentBuffer.size() < 100){
                            ...
                            for (int i = 0; i < ratio; i++) {
                                Random random1 = new Random(random.nextInt(4000));
                                searchs[i] = random1.nextInt(100);
                            }
                        }
                ...
                String sb = tree_type + "\t" +
                        ...
                        radius + "\t" +
                        ratio + "\t";
                bw.write(sb + (System.currentTimeMillis() - startTime));
                System.out.println(sb + (System.currentTimeMillis() - startTime));
                bw.newLine();
                bw.close();
            } catch (Exception e) {
                e.printStackTrace();
